...
export default function Preface() {
  return (
    <>
      <section
        className="fixed bg-pink-200 z-20 h-screen w-full overflow-hidden"
        style={{
      ...
      >
        <div className="h-screen w-full flex justify-center items-center">
          <div className="relative flex flex-col mx-auto w-[450px] bg-white rounded-2xl ">
            <div>
              <Image src={prewed} alt="" className="rounded-2xl " />
            </div>
            ...
            <div className="">
              <div className="absolute -bottom-5 left-0 right-0 mx-auto w-1/2 bg-[#6a8369] opacity-95 hover:opacity-100 rounded-full cursor-pointer">
                <div className="flex py-2 space-x-1 items-center justify-center text-white">
                  <span className="font-bold text-lg">Buka Undangan</span>
                  <span>
                    <svg
