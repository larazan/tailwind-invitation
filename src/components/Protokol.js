  ...
  return (
    <>
      <section className=" bg-[#f2edea] z-20 h-full   w-full overflow-hidden2">
        <div className="py-20 max-w-7xl w-full md:mx-auto">
          <div className="flex flex-col items-center justify-center">
            <p className="font-semibold text-2xl md:text-3xl text-center text-black">
              Protokol Kesehatan
            </p>
            <svg
              width="149"
          ...
          <div className="flex items-center justify-center md:mt-8">
            <div className="w-full flex flex-col md:flex-row  items-center justify-around">
              <div className="flex flex-col items-center justify-center ">
                ...
                <div className="flex w-full xs:w-auto justify-center pt-3 px-4">
                  {/* <span className="text-xl font-medium">01.</span> */}
                  <div className="flex flex-col ml-3 max-w-[264px]">
                    <span className="text-xl font-semibold text-black">Memakai Masker</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center">
                
                <div className="flex justify-center items-center mt-10 bg-[#ffcfb9] rounded-full">
                  <Image
                    src={tangan}
                    alt="detail image"
                    loading="lazy"
                ...
                <div className="flex w-full xs:w-auto justify-center pt-3 px-4">
                  ...
                  <div className="flex flex-col ml-3 max-w-[264px]">
                    <span className="text-xl font-semibold text-black">Mencuci Tangan</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex w-full xs:w-auto justify-center pt-3 px-4">
                  {/* <span className="text-xl font-medium">02.</span> */}
                  <div className="flex flex-col ml-3 max-w-[264px]">
                    <span className="text-xl font-semibold text-black">Menjaga Jarak</span>
                  </div>
                </div>
              </div>
